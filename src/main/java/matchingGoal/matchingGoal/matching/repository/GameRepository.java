...
public interface GameRepository extends JpaRepository<Game, Long> {
  ...
  List<Game> findByTeam1OrTeam2AndTeam2IsNotNullAndDateLessThanEqualAndTimeLessThanOrderByDateDesc(Member team1, Member team1_copy , LocalDate date, LocalTime time);
}
